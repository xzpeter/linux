			  ...
			  u64 *bytenr_ret)
{
	...
	/*
	 * In zoned mode on a non-zoned block device, use the same super block
	 * locations as regular filesystem. Doing so, the super block can
	 * always be retrieved and the zoned mode of the volume detected from
